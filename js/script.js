...
monogatari.script({
    'Start': [
		...
		'На экране телефона появляется сообщение: «Добро пожаловать в Цифровую Петлю. Пройди испытания. Ошибки будут перезапускать день.» ',
	...
	'Restart': [
		'show scene restart duration 10s',
		'Перезагрузка...',
		'show scene alarm',
		'play sound alarm',
		...
		'misha: Ладно, попрорбую снова. Сначала дойду до школы, а потом пойду к Саше.',
		'Он кладет ноутбук в рюкзак и выходит из комнаты', 
		'show scene pochita with fadeIn',
		'misha: Пока, дружок!',
		'play sound door',
	...
	'PlugFlashDriveIn': [
		...
		'Миша осмотреля и увидел поблизости скамейку. Он сел на нее и достал ноутбук.',
		'show scene plugging_in',
		'Он вставляет флешку.', 
		'show scene laptop_broken',  // virus sounds
		'Вдруг экран начинает мерцать, словно новогодняя ёлка.',
		'show scene laptop_blocked',
		'Появилась надпись: «Данные устройства были зашифрованы, для расшифровки переведетие 100$ на биткойн-кошелек.»',
	...
	'SashaHouse': [
		...
		'show scene playing_games', // пиксельные звуки игр
		'Миша и Саша запускают игру на компьютере. Во время загрузки всплывает яркое окно.',
		'show scene game_message',
		'«ПОЗДРАВЛЯЕМ! ТЫ ВЫИГРАЛ iPhone 27 Ultra Pro Max! Для получения приза введи свои ФИО, и номер телефона. Осталось всего 3 приза!»',
		'show scene prize_scam_explanation',
		'misha: Сообщение? «Ты выиграл iPhone 27 Ultra Pro Max!» Серьёзно? Да кому я нужен? iPhone27 еще даже не вышел!',
	...
	'EnterPersonalData': [
		'Миша вводит свои данные в форму. Злоумышленники вносят его данне в базу и начинают ежеминутно звонить с рекламой, а на почту приходит спам. Семья получает SMS о микрозаймах на его имя.',
		'jump Restart'
	],
	'CheckSite': [
		'misha: Так, давай проверим этот сайт. Хмм..Браузер пишет, что соединение незащищенное. Домен какой-то странный: prize-winner-iphone.xyz. Это даже не apple.com! Пфф, фейк фейковый.',
		'show scene prize_scam_explanation',
		'sasha: А ты как понял?',
		'misha: Смотри: во-первых, официальные конкурсы проводятся на официальных сайтах. Во-вторых, они никогда не просят сразу все данные. В-третьих, обрати внимание на наличие безопасного соединения. Если соединение безопасное, то в адресной строке должен находиться символ замочка, а также должно быть написано https вместо http в адресной строке. ',
		'show scene prize_scam_joke',
		'misha: В любом случае, мой сямоми топ за свои деньги)',
		'jump CandyBaby'
	],
	'CandyBaby': [
		'show scene rgb(0, 0, 0) with fadeIn duration 10s',
		...
		'На фото профиля – красивая девушка, явно модельной внешности.',
		{
			'Choice': {
				'Dialog': 'Как поступить?',
				'SendPhoto': {
					'Text': 'Обрадоваться и отправить свое фото – наконец-то повезло!',
					'Do': 'jump SendPhoto'
				},
				'CheckProfilePhoto': {
	...
	'SendPhoto': [
		'show scene saw_message',
		'Миша отправляет свое селфи и продолжает общение.',
		'show scene deepfake',
		'Через десять минут он обнаруживает, что в школьный чат скинули deepfake-видео, где Миша танцует под песню Сигма-бой.',
		'jump Restart'
	],
	'CheckProfilePhoto': [
	...
	'AnswerByMeme': [
		...
		'baby: Я просто хотела познакомиться... Может, фото скинешь? Я тебе потом еще своих пришлю...',
		...
		'Миша блокирует аккаунт и сообщает о нем как о мошенническом. ',
		'show scene woman_explanation',
	...
	'RemoteAccess': [
		...
		'После Миша и Саша решили поиграть в онлайн-игры.',
