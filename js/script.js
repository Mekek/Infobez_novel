...
monogatari.script({
	...
	'Restart': [
		...
		'play sound notification',
		'show scene phone_flash with fadeIn',
		'На экране телефона появляется сообщение: <span style="color:red">«Перезагрузка завершена. Давай по-новой...»</span>',
		'show scene astonishment with fadeIn',
	...
	'Final': [
		...
		'Он берет телефон и видит новое уведомление: <span style="color:green">«Поздравляем. Цикл завершён. Вы прошли все испытания.»</span>',
